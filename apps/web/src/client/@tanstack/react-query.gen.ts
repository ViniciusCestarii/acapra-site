...
export const getPetPetsQueryKey = (options: Options<GetPetPetsData>) =>
  createQueryKey("getPetPets", options);
...
export const getPetPetsInfiniteQueryKey = (
  options: Options<GetPetPetsData>,
): QueryKey<Options<GetPetPetsData>> =>
  createQueryKey("getPetPets", options, true);

export const getPetPetsInfiniteOptions = (options: Options<GetPetPetsData>) => {
  return infiniteQueryOptions<
    GetPetPetsResponse,
    DefaultError,
    InfiniteData<GetPetPetsResponse>,
    QueryKey<Options<GetPetPetsData>>,
    | string
    | number
    | Pick<
        QueryKey<Options<GetPetPetsData>>[0],
...
export const postPetPetsQueryKey = (options: Options<PostPetPetsData>) =>
  createQueryKey("postPetPets", options);
...
export const postPetPetsMutation = (
  options?: Partial<Options<PostPetPetsData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostPetPetsResponse,
    PostPetPetsError,
    Options<PostPetPetsData>
  > = {
...
export const postPetPetsByIdImagesQueryKey = (
  options: Options<PostPetPetsByIdImagesData>,
) => createQueryKey("postPetPetsByIdImages", options);

export const postPetPetsByIdImagesOptions = (
  options: Options<PostPetPetsByIdImagesData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const postPetPetsByIdImagesMutation = (
  options?: Partial<Options<PostPetPetsByIdImagesData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostPetPetsByIdImagesResponse,
    PostPetPetsByIdImagesError,
    Options<PostPetPetsByIdImagesData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postPetPetsByIdImages({
        ...options,
...
export const postPetBreedsMutation = (
  options?: Partial<Options<PostPetBreedsData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostPetBreedsResponse,
    PostPetBreedsError,
    Options<PostPetBreedsData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postPetBreeds({
        ...options,
...
export const postPetSpeciesMutation = (
  options?: Partial<Options<PostPetSpeciesData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostPetSpeciesResponse,
    PostPetSpeciesError,
    Options<PostPetSpeciesData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postPetSpecies({
        ...options,
...
export const postHealthPatientsQueryKey = (
  options: Options<PostHealthPatientsData>,
) => createQueryKey("postHealthPatients", options);

export const postHealthPatientsOptions = (
  options: Options<PostHealthPatientsData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const postHealthPatientsMutation = (
  options?: Partial<Options<PostHealthPatientsData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostHealthPatientsResponse,
    PostHealthPatientsError,
    Options<PostHealthPatientsData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postHealthPatients({
        ...options,
...
export const postAuthUsersRegisterQueryKey = (
  options: Options<PostAuthUsersRegisterData>,
) => createQueryKey("postAuthUsersRegister", options);

export const postAuthUsersRegisterOptions = (
  options: Options<PostAuthUsersRegisterData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const postAuthUsersRegisterMutation = (
  options?: Partial<Options<PostAuthUsersRegisterData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostAuthUsersRegisterResponse,
    PostAuthUsersRegisterError,
    Options<PostAuthUsersRegisterData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postAuthUsersRegister({
        ...options,
...
export const postAuthUsersLoginQueryKey = (
  options: Options<PostAuthUsersLoginData>,
) => createQueryKey("postAuthUsersLogin", options);

export const postAuthUsersLoginOptions = (
  options: Options<PostAuthUsersLoginData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const postAuthUsersLoginMutation = (
  options?: Partial<Options<PostAuthUsersLoginData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostAuthUsersLoginResponse,
    PostAuthUsersLoginError,
    Options<PostAuthUsersLoginData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postAuthUsersLogin({
        ...options,
...
export const postAuthUsersLogoutQueryKey = (
  options?: Options<PostAuthUsersLogoutData>,
) => createQueryKey("postAuthUsersLogout", options);

export const postAuthUsersLogoutOptions = (
  options?: Options<PostAuthUsersLogoutData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const postAuthUsersLogoutMutation = (
  options?: Partial<Options<PostAuthUsersLogoutData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostAuthUsersLogoutResponse,
    PostAuthUsersLogoutError,
    Options<PostAuthUsersLogoutData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postAuthUsersLogout({
        ...options,
